...
from app.models.employee_token import EmployeeToken
...
# Service to get employee ID by token
# def get_employee_id_by_token(db_session, token):
#     return get_emp_id(token)
